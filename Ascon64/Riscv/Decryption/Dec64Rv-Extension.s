...
#this function converts register x to big endian 
 U64BIG :      addi sp,sp,-32              
	       ...
	       RotateRight a0,a0,8  #ROTR64(x,  8) 
	       ...
	       RotateRight a0,t2,24  #ROTR32(x, 24)
	        li t0,0x00FF000000FF0000  #(0xFF000000FF000000ULL))
               ...
               #############################################################
                #addi a1,zero,40
               #add a0,zero,t2 
	       RotateRight a0,t2,40  #ROTR32(x, 40)
	        li t0,0x0000FF000000FF00  #(0xFF000000FF000000ULL))
               ...
               #addi a1,zero,56  
               #add a0,zero,t2 
	       RotateRight a0,t2,56  #ROTR32(x, 24)
