...
EXPAND_U32:PUSH ecx
           ...
           MOV ecx , ebx
           MOV bx , dx
           call EXPAND_SHORT  ;EXPAND_SHORT(t0_o)
           SHL ebx,1
           OR ebx,ecx
           POP ecx
           ret 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;COMPRESS_LONG(x) input->ebx output->bx
 COMPRESS_LONG: PUSH ecx
                AND ebx,0x55555555
                MOV ecx ,ebx
             SHR ebx,1
             OR ebx,ecx
...
COMPRESS_BYTE_ARRAY:PUSH ecx
                   ...
                   MOV ecx,ebx
                   SHR ebx,1
                   call COMPRESS_LONG  ;t1_o
                   MOV edx,ebx
                   SHL edx,16  ;t1_o<<16
                   MOV ebx,ecx
                   call COMPRESS_LONG ;t1_e
                   MOV eax,ebx
                   SHL eax,16  ;t1_e<<16
                   MOV ebx ,[esi+4]
                   BSWAP ebx
                   MOV ecx,ebx
                   SHR ebx,1
                   call COMPRESS_LONG  ;var_o
                   OR edx,ebx
                   MOV ebx,ecx
                   call COMPRESS_LONG ;var_e
                   OR ebx,eax
                   POP ecx
                   ret
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
FIRST_LOOP:CMP ecx ,8
      ...
      SHR ebx,16
      SHR edx,16
      call EXPAND_U32 ;EXPAND_U32(var,var_o,var_e)-> var_o=dx , var_e=bx , var=ebx
      BSWAP ebx
      MOV [edi],ebx      
      POP dx
      POP bx
